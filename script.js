  ...
  if (contactForm) {
    ...
    const getErrorMessage = function (field, rule) {
      ...
      const messages = {
        ...
        minlength:
          label + ' must be at least ' + field.getAttribute('data-minlength') + ' characters.',
      };
    ...
    const validateField = function (field) {
      ...
      if (field.dataset.minlength && value.trim() !== '') {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Fix Design משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9bf3efa3-493a-456d-9ead-c460a4cec57f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9bf3efa3-493a-456d-9ead-c460a4cec57f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9bf3efa3-493a-456d-9ead-c460a4cec57f';
